...
public class LinkedList1 {
    ...
    public static LinkedList1 insert(LinkedList1 list,
                                    int data)
    {
    ...
    public static LinkedList1 deleteByKey(LinkedList1 list,
                                         int key)
    {
        // Store head node
    ...
    public static LinkedList1
    deleteAtPosition(LinkedList1 list, int index)
    {
        // Store head node
        Node currNode = list.head, prev = null;
