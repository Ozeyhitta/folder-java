...
public class LinkedListManual<T> {
    ...
    public static LinkedListManual insert(LinkedListManual list,
                                          int data)
    {
    ...
    public static void printList(LinkedListManual list)
    {
    ...
    public static LinkedListManual deleteByKey(LinkedListManual list,
                                               int key)
    {
        // Store head node
    ...
    public static LinkedListManual
    deleteAtPosition(LinkedListManual list, int index)
    {
        // Store head node
        Node currNode = list.head, prev = null;
